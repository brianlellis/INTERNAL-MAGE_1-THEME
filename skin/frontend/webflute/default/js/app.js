...
var PointerManager = {
    ...
    getPointerEventsSupported: function getPointerEventsSupported() {
        return this.standardTouch;
    },

    getPointerEventsInputTypes: function getPointerEventsInputTypes() {
    ...
    setPointerEventLock: function setPointerEventLock() {
        this.pointerEventLock = true;
    },
    clearPointerEventLock: function clearPointerEventLock() {
        this.pointerEventLock = false;
    },
    setPointerEventLockTimeout: function setPointerEventLockTimeout() {
        var that = this;
    ...
    triggerMouseEvent: function triggerMouseEvent(originalEvent) {
    ...
    triggerTouchEvent: function triggerTouchEvent(originalEvent) {
    ...
    wirePointerDetection: function wirePointerDetection() {
        var that = this;
...
var MenuManager = {
    ...
    TouchScroll: {
         ...
         * @returns {boolean}
         */
        shouldCancelTouch: function shouldCancelTouch() {
     ...
     * @returns {boolean}
     */
    useSmallScreenBehavior: function useSmallScreenBehavior() {
     ...
     * @param target
     */
    toggleMenuVisibility: function toggleMenuVisibility(target) {
        var link = $j(target);
     ...
     */
    wirePointerEvents: function wirePointerEvents() {
        var that = this;
    ...
    PartialPointerEventsSupport: {
         ...
         * @param target
         */
        mouseEnterAction: function mouseEnterAction(event, target) {
         ...
         * @param target
         */
        mouseLeaveAction: function mouseLeaveAction(event, target) {
            if (MenuManager.useSmallScreenBehavior()) {
                // fall back to normal method behavior
         ...
         * @param target
         */
        touchAction: function touchAction(event, target) {
            if (MenuManager.useSmallScreenBehavior()) {
                // fall back to normal method behavior
     ...
     * @param target
     */
    mouseClickAction: function mouseClickAction(event, target) {
        if (this.useSmallScreenBehavior()) {
...
$j(document).ready(function () {
    ...
    if ($j('.products-grid').length) {
        ...
        var alignProductGridActions = function alignProductGridActions() {
...
var ProductMediaManager = {
    ...
    destroyZoom: function destroyZoom() {
        $j('.zoomContainer').remove();
        $j('.product-image-gallery .gallery-image').removeData('elevateZoom');
    },

    createZoom: function createZoom(image) {
    ...
    swapImage: function swapImage(targetImage) {
    ...
    wireThumbnails: function wireThumbnails() {
